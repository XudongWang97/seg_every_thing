...
def main(input_model, output_model):
    ...
    assert weights['blobs']['cls_score_w'].shape == (3007, 1024)
    assert weights['blobs']['cls_score_b'].shape == (3007,)
    assert weights['blobs']['bbox_pred_w'].shape == (3007 * 4, 1024)
    assert weights['blobs']['bbox_pred_b'].shape == (3007 * 4,)
