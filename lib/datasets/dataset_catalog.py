...
DATASETS = {
    ...
    # Hardhat and Uniform
    'vg3k_cocoaligned_train_hardhat': {
        IM_DIR:
            _DATA_DIR + '/vg/images',
        ANN_FN:
            _DATA_DIR + '/vg3k_bbox2mask/instances_vg3k_cocoaligned_train_addHardhatUniform.json'
    },
    'vg3k_cocoaligned_val_hardhat': {
        IM_DIR:
            _DATA_DIR + '/vg/images',
        ANN_FN:
            _DATA_DIR + '/vg3k_bbox2mask/instances_vg3k_cocoaligned_val_addHardhatUniform.json'
    },
    'vg3k_cocoaligned_test_hardhat': {
        IM_DIR:
            _DATA_DIR + '/vg/images',
        ANN_FN:
            _DATA_DIR + '/vg3k_bbox2mask/instances_vg3k_cocoaligned_test_addHardhatUniform.json'
    },
    'hardhat_uniform_train': {
        IM_DIR:
            _DATA_DIR + '/hardhat_uniform/JPEGImages',
        ANN_FN:
            _DATA_DIR + '/hardhat_uniform/train_cocostyle.json'
    },
    'hardhat_uniform_train_vg3k': {
        IM_DIR:
            _DATA_DIR + '/hardhat_uniform/JPEGImages',
        ANN_FN:
            _DATA_DIR + '/hardhat_uniform/train_vg3kstyle.json'
    },
    'hardhat_uniform_val': {
        IM_DIR:
            _DATA_DIR + '/hardhat_uniform/JPEGImages',
        ANN_FN:
            _DATA_DIR + '/hardhat_uniform/val_cocostyle.json'
    },
    'hardhat_uniform_val_vg3k': {
        IM_DIR:
            _DATA_DIR + '/hardhat_uniform/JPEGImages',
        ANN_FN:
            _DATA_DIR + '/hardhat_uniform/val_vg3kstyle.json'
    },
}
